...
def main():
    ...
    api: iwls.IWLSapiPublic = iwls.get_iwls_api(
        ...
        # If True, a iwls.RetryAdapterConfig object is created with the following parameters:
        ...
        # A custom iwls.RetryAdapterConfig object can be passed as parameters
        retry_adapter_config=True,  # Can be a boolean or a custom iwls.RetryAdapterConfig object
        ...
        session_type_config=iwls.SessionType.REQUESTS,  # Can be a SessionType object or a CachedSessionConfig object
    )
    ...
    station_metadata: iwls.Response = api.get_metadata_station(
        station=station_id
    ...
    wlo: iwls.Response = api.get_time_serie_block_data(
        time_serie_code=iwls.TimeSeries.WLO,  # TimeSeries.WLP for water level predictions, TimeSeries.WLO for water level observations, etc.
        station=station_id,
        from_time=from_time,
        to_time=to_time,
    )
