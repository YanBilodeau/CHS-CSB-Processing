...
"%python%" "%processing%" process D:\Dev\CHS-CSB_Processing\src\ingestion\Lowrance\Tuktoyaktuk --output D:\Dev\CHS-CSB_Processing\Output --excluded-station 06525 --excluded-station 03755
rem --waterline 1.4 
